...
## 工作模式
- **開工**：對 Claude 說「**開工**」→ 讀 Obsidian 工作日誌、檢查 git 狀態（含遠端 fetch）、回報上次做到哪 + 建議下一步
- **加新工具**：對 Claude 說「我想做一個 XXX 工具」→ Claude 會建 `tools/<工具名>/` 子資料夾
- **結束工作**：對 Claude 說「**收工**」→ 自動 commit + push + 更新 Obsidian 工作日誌
- **接續工作**：對 Claude 說「讀工作日誌，告訴我上次做到哪」（與「開工」效果類似，但更輕量）

## 工作桌 + 三個家
- 📂 本地工作桌：`C:\Users\linte\Projects\2026Claude一桌三櫃\`（單機作業）
